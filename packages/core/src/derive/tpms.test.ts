...
describe("assessTpms", () => {
  ...
  it("markiert bei Achs-Ungleichgewicht nur den niedrigeren Reifen", () => {
  ...
  it("markiert ab genau 0,2 bar nur den niedrigeren Reifen", () => {
    const r = assessTpms({ fl: 2.9, fr: 2.7, rl: 2.9, rr: 2.9 });
  ...
  it("warnt knapp unter 0,2 bar noch nicht", () => {
    const r = assessTpms({ fl: 2.9, fr: 2.71, rl: 2.9, rr: 2.9 });
